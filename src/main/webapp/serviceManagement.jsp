...
<a href="<%=request.getContextPath()%>/register.jsp" class="btn btnsuccess">Add New Service</a>
</div>
<br>
...
<td>
<c:out value="${service.serviceImage}" />
</td>
<td>
...
<td>
<a href="edit?name=<c:out value='${service.serviceName}'
/>">Edit</a> &nbsp;&nbsp;&nbsp;&nbsp;
